...
RSpec.describe NexusSync::RubygemsItem do
  ...
  describe '#download' do
    it 'sends #download to a connection object' do
      item = NexusSync::RubygemsItem.new(component, asset, download_location)
      connection = double
  ...
  describe '#upload' do
    it 'sends #upload_rubygems_component to a connection object' do
      item = NexusSync::RubygemsItem.new(component, asset, download_location)
      connection = double
      allow(connection).to receive(:upload_rubygems_component).and_return(true)
