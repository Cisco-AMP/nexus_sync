...
RSpec.describe NexusSync::YumItem do
  ...
  describe '#download' do
    it 'sends #download to a connection object' do
      item = NexusSync::YumItem.new(component, asset, download_location)
      connection = double
  ...
  describe '#upload' do
    it 'sends #upload_yum_component to a connection object' do
      item = NexusSync::YumItem.new(component, asset, download_location)
      connection = double
      allow(connection).to receive(:upload_yum_component).and_return(true)
