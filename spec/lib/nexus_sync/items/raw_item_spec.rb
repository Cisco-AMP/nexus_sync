...
RSpec.describe NexusSync::RawItem do
  ...
  describe '#download' do
    it 'sends #download to a connection object' do
      item = NexusSync::RawItem.new(component, asset, download_location)
      connection = double
  ...
  describe '#upload' do
    it 'sends #upload_raw_component to a connection object' do
      item = NexusSync::RawItem.new(component, asset, download_location)
      connection = double
      allow(connection).to receive(:upload_raw_component).and_return(true)
